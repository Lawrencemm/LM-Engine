...
namespace lmeditor
{
entt::entity entity_editor_controller::nearest_entity(
...
entt::entity entity_editor_controller::farthest_entity(
  entt::registry const &map,
  const Eigen::Vector3f &direction)
{
    auto transforms = map.view<lmng::transform const>();
...
bool entity_editor_controller::move_selection(
  entt::registry const &map,
...
bool entity_editor_controller::move_selection_view(
  entt::registry const &map,
...
void entity_editor_controller::set_map(const entt::registry &registry)
{
