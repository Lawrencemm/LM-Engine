...
namespace lmeditor
{
class entity_editor_controller : public viewport
{
  public:
    explicit entity_editor_controller(
      entt::registry &map,
    ...
    struct command_args
    {
        class entity_editor_controller &controller;
        entt::registry &map;
    ...
    struct select_state
    {
        ...
        explicit select_state(other_state_type &,
          entity_editor_controller &model)
            : select_state{model} {};

        explicit select_state(entity_editor_controller &model);
    ...
    struct translate_state
    {
        ...
        explicit translate_state(select_state &, entity_editor_controller &);
    ...
    struct reparent_state
    {
        ...
        reparent_state(select_state &, entity_editor_controller &model);
    ...
    struct scale_state
    {
        ...
        scale_state(select_state &, entity_editor_controller &model);
    ...
    struct rotate_state
    {
        ...
        rotate_state(select_state &, entity_editor_controller &model);
...
template <typename new_state_type, typename current_state_type>
auto entity_editor_controller::enter_state(current_state_type &current_state)
{
    static_assert(
      std::is_same_v<
        current_state_type,
