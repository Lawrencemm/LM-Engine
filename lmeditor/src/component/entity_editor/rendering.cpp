...
namespace lmeditor
{
lmgl::buffer entity_editor::create_selection_ubuffer(lmgl::irenderer *renderer)
{
...
lmgl::material
  entity_editor::create_selection_stencil_material(
...
lmgl::material entity_editor::create_outline_material(lmgl::irenderer *renderer)
{
    return renderer->create_material(lmgl::material_init{
      .vshader_spirv = lm::raw_array_proxy(stencil_vshader_data),
...
void entity_editor::render_selection_outline(
  lmgl::iframe *frame,
...
void entity_editor::render_state_text(lmgl::iframe *frame)
{
