...
{
    typedef lmeditor::trimesh_point Point;
    typedef lmeditor::trimesh_point Normal;
    typedef lmeditor::trimesh_point Color;
...
class trimesh : public OpenMesh::TriMesh_ArrayKernelT<trimesh_traits>
{
  public:
    ...
    {
        lmeditor::trimesh::VertexHandle vertex_handle;
    };
    struct edge_geo_element
    {
        lmeditor::trimesh::EdgeHandle edge_handle;
    };
