...
entity_editor_controller::command create_orbit_command(char const *name)
{
...
entity_editor_controller::command move_camera_forward_command{
  [](entity_editor_controller::command_args const &args) {
...
entity_editor_controller::command move_camera_back_command{
  [](entity_editor_controller::command_args const &args) {
...
entity_editor_controller::command move_to_selection_command{
  [](entity_editor_controller::command_args const &args) {
...
entity_editor_controller::command_list
  entity_editor_controller::viewport_commands{
