...
TEST_CASE("Hierarchy system")
{
    ...
    registry.emplace<lmng::transform>(parent, transform);
    registry.emplace<lmng::transform>(child, transform);
    ...
    SECTION("Reparent")
    {
        ...
        registry.emplace<lmng::transform>(new_parent, new_parent_transform);
...
TEST_CASE("Recursive hierarchy range")
{
    ...
    registry.emplace<lmng::name>(child_1, "Child 1");
    registry.emplace<lmng::parent>(child_1, parent);

    auto child_1_child_1 = registry.create();
    registry.emplace<lmng::name>(child_1_child_1, "Child 1 child 1");
    registry.emplace<lmng::parent>(child_1_child_1, child_1);

    auto child_1_child_2 = registry.create();
    registry.emplace<lmng::name>(child_1_child_2, "Child 1 child 2");
    registry.emplace<lmng::parent>(child_1_child_2, child_1);

    auto child_2 = registry.create();
    registry.emplace<lmng::name>(child_2, "Child 2");
    registry.emplace<lmng::parent>(child_2, parent);

    auto child_2_child = registry.create();
    registry.emplace<lmng::name>(child_2_child, "Child 2 child");
    registry.emplace<lmng::parent>(child_2_child, child_2);
    ...
    for (auto curr_child : lmng::recursive_child_range{registry, parent})
    {
        ...
        registry.emplace<unsigned>(curr_child, counter++);
    }
...
TEST_CASE("Hierarchy manipulation")
{
    ...
    registry.insert(children.begin(), children.end(), lmng::parent{parent});
